...
CXXFLAGS="-std=c++11"
OUT=solver
SOURCES="src/main.cpp src/app.cpp src/font_bitmap.cpp src/state_editing.cpp src/state_listing.cpp src/state_solving.cpp src/state_show_solution.cpp src/solver.cpp"
